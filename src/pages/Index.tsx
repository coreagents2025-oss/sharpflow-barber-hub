        ...
        <div className="container mx-auto px-4 sm:px-6 py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a href={`https://wa.me/5541983455701?text=${encodeURIComponent('Olá! Gostaria de mais informações sobre os serviços da barbearia.')}`} target="_blank" rel="noopener noreferrer" className="text-primary-foreground/80 hover:text-accent transition-colors flex items-center gap-2">
