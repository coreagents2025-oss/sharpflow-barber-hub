        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            {!isInAdminPanel && <Button 
                ...
                onClick={() => window.open(`https://api.whatsapp.com/send/?phone=554198345701&text=${encodeURIComponent('Olá! Gostaria de mais informações sobre os serviços da barbearia.')}`, '_blank')}
              >
                Chamar no WhatsApp
              </Button>}
          </div>
